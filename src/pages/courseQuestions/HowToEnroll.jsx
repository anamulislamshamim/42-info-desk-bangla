          ...
          20 Nov 2020
            ...
            <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
                ...
                <p className="text-base text-green-700 md:text-lg text-justify">
                    কোর্সে ভর্তি হওয়ার জন্য তোমাকে 42infodeskbangla@gmail.com এ ইমেইল করে নিশ্চিত করতে হবে তুমি ভর্তি হতে ইচ্ছুক। ইমেইল এর subject: Application For Piscine Preparation Course ।
                    ...
                    তুমি চাইলে বাংলায় লিখতে পারো।
                    <img src="email_format.jpg" alt="internship" style={{ "margin": "20px 0" }} />
