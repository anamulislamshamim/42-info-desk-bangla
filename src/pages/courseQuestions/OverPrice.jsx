          ...
          20 Nov 2020
            ...
            <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
                ...
                <p className="text-base text-green-700 md:text-lg text-justify">
                    ...
                    <span className='text-red-500'> এটা তোমার বিবেকের কাছে আমার প্রশ্ন ?</span> তারপরও যদি বলো over priced, তাহলে আমি বলবো ভাই তুমি একটা এজেন্সী ধরে যাও। তাদের কে ১৫-২০ লক্ষ টাকা দাও!
                </p>
            </div>
