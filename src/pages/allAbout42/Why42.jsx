          ...
          20 Nov 2020
            ...
            <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
                ...
                <p className="text-base text-green-700 md:text-lg text-justify">
                    ...
                    জব requirements এ university শব্দটা বাদ দিয়ে দিবে! এর মানে তোমার university থেকে গ্রাজুয়েট হওয়ার প্রযোজন নাই। তোমার যদি টেকনিক্যাল নলেজ থাকে তাহলেই তুমি SAP apply করতে পারবে !
                    ...
                    এটা লেখাপড়ার একটা অংশ। ইন্টার্নশীপ শেষ করে আবার নতুন সেমিস্টার শুরু করতে হয় !  তার উপর 42 তে যেহেতু Pair  Learning (অর্থাৎ Team  Work ) করে তাই 42 স্টুডেন্টদের ভিতর Team Work , একে উপর কে help করা , প্ল্যান করেন কাজ করা ইত্যাদি Soft -skills achieve করে।  
