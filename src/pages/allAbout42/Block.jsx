          ...
          20 Nov 2020
            ...
            <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
                ...
                <p className="text-base text-green-700 md:text-lg text-justify">
                    ...
                    আমি তোমাদের On-site টা করার জন্য বলবো।
                    এতে তোমার মনোবল থাকবে অন্যরকম। On-site এ করার জন্য আগে থেকে visa appointemt এর জন্য apply করবা। 
                    ...
                    তখন তুমি তোমার <span className='text-red-500'>ভিসার মেয়াদ 4 বছর পযর্ন্ত বাড়াতে পারবা</span>। যদি Piscine এ Fail করো তাহলে ৩ মাসের ভিতর দেশে চলে আসতে হবে!
                    যেহেতু Piscine শেষ হলে তুমি Pscine এর প্রজেক্ট গুলো দিয়ে Resume বানিয়ে <span className='text-white'>ইন্টার্নশীপ এর জন্য আবেদন</span> করতে পারবা। 
                    <span className='text-red-500'> কাজেই ইন্টার্নশীপ পেয়ে গেলে ৬ মাসের ইনকাম দিয়ে অনায়াসে ২
                    ...
                    ভিসা হবে 4 বছরের। তাই 4 বছর থাকার মতো টাকা ব্যাংকে রাখতে হবে! তবে ভালো খবর ও আছে! সেটা হলো যেহেতু তুমি Piscine শেষ করে ফেলছো,
                    তুমি চাইলে বাংলাদেশ থেকে বিভিন্ন IT কোম্পানি তে Apply করতে পারো। যদি ইন্টার্নশীপ পেয়ে যাও তাহলে তো কথাই নাই!
                    জব ভিসার জন্য Apply করবা 1-3 মাসের মধ্যেই ভিসা পেয়ে যাবে! তবে আমি পরামর্শ দিবো On-site Piscine করার জন্য।
