          ...
          20 Nov 2020
            ...
            <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
                ...
                <p className="text-base text-green-700 md:text-lg text-justify">
                    ...
                    দূঃচিন্তার কিছুই নাই। Piscine কমপ্লিট করে তুমি চাইলে Piscine এর প্রজেক্টস গুলা তোমার Resume তে Add করে বিভিন্ন IT কোম্পানিতে ইন্টার্ন জব এর জন্য Apply করতে পারবে।
                    জার্মানিতে ইন্টার্ন এর স্যালারি <span className='text-red-500'>২০০০ ইউরো</span> বেশি হয় যা বাংলাদেশী টাকায় <span className='text-red-500'>২ লক্ষ</span> টাকার বেশি!
