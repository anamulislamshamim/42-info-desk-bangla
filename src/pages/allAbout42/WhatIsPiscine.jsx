          ...
          20 Nov 2020
            ...
            <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
                ...
                <p className="text-base text-green-700 md:text-lg text-justify">
                    ...
                    এই একমাস তোমায় প্রতিদিন গড়ে <span className='text-red-500'>১০-১৪ ঘন্টা</span> কোডিং করতে হবে। মানে তোমার রাত-দিন এক করে কোডিং করতে হবে।
                    Piscine কেমন হতে পারে এমন ধারণা পেতে চাইলে তুমি YouTube
                    coding girl  নাম একটা channel আছে। মেয়ে টা রাশিয়ান। এখন রাশিয়ার সব চেয়ে বড় IT কোম্পানি অথবা গুগল এর রাশিয়ান শাখা তে software engineer হিসাবে জব করতেছে। 
                    ওই চেনেল এ অনেক কিছু জানতে পারবা।
                    Piscine কেমন হয়। 4 টা প্রজেক্ট 4 সপ্তাহে কমপ্লিট করতে হবে। <span className='text-red-500'>Piscine কিন্তু মোটেও সহজ না! কারণ, 
