          ...
          20 Nov 2020
            ...
            <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
                ...
                <p className="text-base text-green-700 md:text-lg text-justify">
                    ...
                    তোমার মতো WORLD বিভিন্ন দেশ থেকেই ছেলে-মেয়েরা Apply করবে। আমি যতদূর জানতে পেরেছি, 47 টি দেশ থেকে স্টুডেন্টরা লেখাপড়া করতেছে।  
                    আমি বাংলাদেশের প্রথম Student যে এমন সুযোগ নিতে পেরেছি। আশা করি, তুমিও পারবে। 
                    কাজেই Application সঠিক ভাবে করা, Game এ ভালো করা, Piscine এ 4 টা প্রজেক্ট সফল ভাবে করা একটু জটিল।
