          ...
          20 Nov 2020
            ...
            <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
                ...
                <p className="text-base text-green-700 md:text-lg text-justify">
                    ...
                    <span className='text-white'> এই কোর্স এ তোমাদের C প্রোগ্রামিং এর বেসিক + ৫ টা অথবা প্রয়াজন হলে তার থেকে বেশি প্রজেক্ট করানো হবে। তারপর তোমাদের piscine মতো হুবহু ১ মাস ব্যাপি
                    ...
                    এক কোথায়, পুরো application প্রসেস এবং  piscine যেন সফল ভাবে উত্তীণ হতে পারো এটাই আমাদের লক্ষ্য !
